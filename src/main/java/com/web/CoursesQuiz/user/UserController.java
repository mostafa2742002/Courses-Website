...
public class UserController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "500", description = "Failed to send verification email")
    })
    @PostMapping("/signup")
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Course attended successfully"),
            @ApiResponse(responseCode = "400", description = "Bad request")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Course completed successfully"),
            @ApiResponse(responseCode = "400", description = "Bad request")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Course reset successfully"),
            @ApiResponse(responseCode = "417", description = "Failed to reset course")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Lesson attended successfully"),
            @ApiResponse(responseCode = "400", description = "Bad request")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Lesson reset successfully"),
            @ApiResponse(responseCode = "417", description = "Failed to reset lesson")
    })
